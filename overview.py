...
class Overview(QtGui.QWidget):
    ...
    def overViewChangedf(self,state):
        if state: 
            self.overViewChanged = True
        else: 
    ...
    #     print 'Navigating to in Overview' + navfile
    #     ypos = 0
    ...
    def process_data(self,event,qp,height_line):
        ...
        for filename, Data in self.dataModel.iteritems():
            ...
            # print self.position
            # Processing for x coordinate 
            # print self.dataModel[filename]
            # if i == 500: 
            #     break
            # print i 
            # pprint.pprint(Data)
    ...
    def drawHorizontalLine(self,event, qp, Data, filename):
        ...
        i=0 
        self.y_coordinate += self.height_each_line
        # if not(self.BugDataState):
        for data in Data: 
                # pprint.pprint(data[self.visHeatMap])
        ...
        if self.overViewChanged:
            if self.BugDataState:
                ...
                try: 
                    ...
                    # self.draw_White_Line(event, qp, line_x_coordinate_begin_global*self.scale, self.y_coordinate,float(line_length)*self.scale, float(self.height_each_line),(255,255,255,255))
                    pass
    ...
    def draw_line(self,event,qp,begin_x_coordinate,begin_y_coordinate,length,height,interpolation_points_time,interpolation_points_author,author_colors):
        ...
        qp.setPen(QtGui.QPen(QtCore.Qt.black, 0, QtCore.Qt.SolidLine, QtCore.Qt.RoundCap, QtCore.Qt.RoundJoin))
